...
class _$TaskModelImpl implements _TaskModel {
  ...
  @override
  String toString() {
    return 'TaskModel(id: $id, name: $name, description: $description, durationSeconds: $durationSeconds, icon: $icon)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, description, durationSeconds, icon);
